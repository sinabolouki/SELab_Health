...
service_urls = {
    ...
    doctor_add_prescription: 'http://127.0.0.1:8000/api/doctor/add_prescription',
    doctor_list_prescriptions: 'http://127.0.0.1:8000/api/doctor/prescriptions',
    patient_list_prescriptions: 'http://127.0.0.1:8000/api/patient/prescriptions',
    admin_list_prescriptions:'http://127.0.0.1:8000/api/admin/prescriptions',
    admin_get_daily:'http://127.0.0.1:8000/api/admin/daily_report',
}
